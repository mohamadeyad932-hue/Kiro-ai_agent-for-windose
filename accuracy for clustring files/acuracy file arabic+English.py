...
CSV_PATH        = os.path.join(os.path.dirname(os.path.abspath(__file__)), "my_dataset_arb_and_english.csv")
BBC_ROOT        = r"C:\Users\eyad\Documents\arabic and english data set"
...
NUM_TRUE_CATEGORIES = 3

# ─────────────── كاش ───────────────

CACHE_DIR          = os.path.dirname(os.path.abspath(__file__))
VECTORS_CACHE_PATH = os.path.join(CACHE_DIR, "arabic+and+english_vectors.npy")
LABELS_CACHE_PATH  = os.path.join(CACHE_DIR, "arabic+and+english_labels.npy")
NAMES_CACHE_PATH   = os.path.join(CACHE_DIR, "arabic+and+english_names.npy")
